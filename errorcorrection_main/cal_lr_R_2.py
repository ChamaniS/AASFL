...
def cal_lr(e11, e12, e21, e22,e31, e32):
    def equations(variables):
        n1, n2, n3, delta, sigma = variables
    ...
    def constraints(variables):
        n1, n2, n3, delta, sigma = variables
        return [n1 - 0.1, 1 - n1, n2 - 0.1, 1 - n2, n3 - 0.1, 1 - n3]

    # Initial guess for variables
    initial_guess = [1.0, 1.0, 1.0, 0.5, 0.5]
    ...
    n1, n2, n3, delta, sigma = optimized_variables
