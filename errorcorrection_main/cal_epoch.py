...
def cal_epoch(e11, e12, e13, e21, e22, e23,e31, e32, e33, e41, e42, e43, e51, e52, e53):
    A = np.array([[e11, e12, e13],[ e21,  e22, e23],[e31, e32, e33],[e41, e42,e43],[e51, e52, e53]])
    ...
    for E1 in np.arange(lower_bound, upper_bound + 1):
        for E2 in np.arange(lower_bound, upper_bound + 1):
            for E3 in np.arange(lower_bound, upper_bound + 1):
                for E4 in np.arange(lower_bound, upper_bound + 1):
                    for E5 in np.arange(lower_bound, upper_bound + 1):
                        # Right-hand side vector b based on the current E values
                        b = np.array([E1, E2, E3, E4, E5])
    ...
    print("E3 =", best_E_values[2])
    print("E4 =", best_E_values[3])
    print("E5 =", best_E_values[4])
