...
dataDir="C:/Users/csj5/Projects/BlastocystDATA/datafed/data/shuffled/federated/"
...
def main():
    ...
    for idx in range(5):
        ...
        screen_opt1 = optim.Adam(localmodel1.parameters(), lr=args.screen_lr)
        screen_opt2 = optim.Adam(localmodel2.parameters(), lr=args.screen_lr)
        screen_opt3 = optim.Adam(localmodel3.parameters(), lr=args.screen_lr)
        ...
        for epoch in range(args.screen_ep):
            ...
            if cl_idx == 2:  # C2--------------------------------------------------------------C2 screen training & validation--------------------------------------------------------------------------------------------------------------------
                S_train_epoch_loss, S_train_epoch_acc, S_trainepoch_iou_withbackground, S_trainepoch_iou_nobackground, S_trainepoch_iou_class0, S_trainepoch_iou_class1, S_trainepoch_iou_class2, S_trainepoch_iou_class3, S_trainepoch_iou_class4 , isreliable1= train_screen(
                    train_loader, localmodel1, localmodel2, localmodel3, screen_opt1, screen_opt2, screen_opt3,loss_fn, SC2_PL)
                print("Client", cl_idx, "local validating.........")
                S_val_epoch_loss, S_val_epoch_acc, S_valepoch_iou_withbackground, S_valepoch_iou_nobackground, S_valepoch_iou_class0, S_valepoch_iou_class1, S_valepoch_iou_class2, S_valepoch_iou_class3, S_valepoch_iou_class4 = eval(
                ...
                if least_lossC2S > S_val_epoch_loss:
                    ...
                    torch.save(localmodel1.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C2M1_localcheckpointS.pth')
                    torch.save(localmodel2.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C2M2_localcheckpointS.pth')
                    torch.save(localmodel3.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C2M3_localcheckpointS.pth')
                    print('C2localmodel saved')
            if cl_idx == 3:  # C3--------------------------------------------------------------C3 screen training & validation-----------------------------------------------------------------------------------------------------------
                S_train_epoch_loss, S_train_epoch_acc, S_trainepoch_iou_withbackground, S_trainepoch_iou_nobackground, S_trainepoch_iou_class0, S_trainepoch_iou_class1, S_trainepoch_iou_class2, S_trainepoch_iou_class3, S_trainepoch_iou_class4, isreliable1 = train_screen(
                    train_loader, localmodel1, localmodel2, localmodel3, screen_opt1, screen_opt2, screen_opt3,loss_fn, SC3_PL)
                print("Client", cl_idx, "local validating.........")
                S_val_epoch_loss, S_val_epoch_acc, S_valepoch_iou_withbackground, S_valepoch_iou_nobackground, S_valepoch_iou_class0, S_valepoch_iou_class1, S_valepoch_iou_class2, S_valepoch_iou_class3, S_valepoch_iou_class4 = eval(
                ...
                if least_lossC3S > S_val_epoch_loss:
                    ...
                    torch.save(localmodel1.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C3M1_localcheckpointS.pth')
                    torch.save(localmodel2.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C3M2_localcheckpointS.pth')
                    torch.save(localmodel3.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C3M3_localcheckpointS.pth')
                    print('C3localmodel saved')
            if cl_idx == 4:  # C4--------------------------------------------------------------C4 screen training & validation-----------------------------------------------------------------------------------------------------------
                S_train_epoch_loss, S_train_epoch_acc, S_trainepoch_iou_withbackground, S_trainepoch_iou_nobackground, S_trainepoch_iou_class0, S_trainepoch_iou_class1, S_trainepoch_iou_class2, S_trainepoch_iou_class3, S_trainepoch_iou_class4 , isreliable1= train_screen(
                    train_loader, localmodel1, localmodel2, localmodel3, screen_opt1, screen_opt2, screen_opt3,loss_fn, SC4_PL)
                print("Client", cl_idx, "local validating.........")
                S_val_epoch_loss, S_val_epoch_acc, S_valepoch_iou_withbackground, S_valepoch_iou_nobackground, S_valepoch_iou_class0, S_valepoch_iou_class1, S_valepoch_iou_class2, S_valepoch_iou_class3, S_valepoch_iou_class4 = eval(
                ...
                if least_lossC4S > S_val_epoch_loss:
                    ...
                    torch.save(localmodel1.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C4M1_localcheckpointS.pth')
                    torch.save(localmodel2.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C4M2_localcheckpointS.pth')
                    torch.save(localmodel3.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C4M3_localcheckpointS.pth')
            ...
            if cl_idx == 5:  # C5--------------------------------------------------------------C5 screen training & validation-----------------------------------------------------------------------------------------------------------
                ...
                if least_lossC5S > S_val_epoch_loss:
                    ...
                    torch.save(localmodel1.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C5M1_localcheckpointS.pth')
                    torch.save(localmodel2.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C5M2_localcheckpointS.pth')
                    torch.save(localmodel3.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C5M3_localcheckpointS.pth')
    ...
    #Define each client’s contribution scale (CCS) based on Data ratio and whether each client is R or NR
    #Based on CCS determine the local epochs, LR
    ...
    R_cls =[1,2,3]
    NR_cls = [4,5]
    lr_C1 = lr_C2 = lr_C3 = args.lr_R
    lr_C4 = lr_C5  = args.lr_NR
    '''
    ...
    #Ratio for PL probaility
    S_C1M1 = (1 - args.pack_prob_up_C1)
    S_C1M2 = (1 - args.pack_prob_up_C1)
    S_C1M3 = (1 - args.pack_prob_up_C1)
    S_C2M1 = (1 - args.pack_prob_up_C2)
    S_C2M2 = (1 - args.pack_prob_up_C2)
    S_C2M3 = (1 - args.pack_prob_up_C2)
    S_C3M1 = (1 - args.pack_prob_up_C3)
    S_C3M2 = (1 - args.pack_prob_up_C3)
    S_C3M3 = (1 - args.pack_prob_up_C3)
    S_C4M1 = (1 - args.pack_prob_up_C4)
    S_C4M2 = (1 - args.pack_prob_up_C4)
    S_C4M3 = (1 - args.pack_prob_up_C4)
    S_C5M1 = (1 - args.pack_prob_up_C5)
    S_C5M2 = (1 - args.pack_prob_up_C5)
    S_C5M3 = (1 - args.pack_prob_up_C5)

    SM1 = S_C1M1 + S_C2M1 + S_C3M1 + S_C4M1 + S_C5M1
    SM2 = S_C1M2 + S_C2M2 + S_C3M2 + S_C4M2 + S_C5M2
    SM3 = S_C1M3 + S_C2M3 + S_C3M3 + S_C4M3 + S_C5M3
    ...
    intot_loss = (1 / DQ1 + 1 / DQ2 + 1 / DQ3 + 1 / DQ4 + 1 / DQ5)
    ...
    C1M1h = D1 + RC1M1 + DQDis1
    C1M2h = D1 + RC1M2 + DQDis1
    C1M3h = D1 + RC1M3 + DQDis1
    C2M1h = D2 + RC2M1 + DQDis2
    C2M2h = D2 + RC2M2 + DQDis2
    C2M3h = D2 + RC2M3 + DQDis2
    C3M1h = D3 + RC3M1 + DQDis3
    C3M2h = D3 + RC3M2 + DQDis3
    C3M3h = D3 + RC3M3 + DQDis3
    C4M1h = D4 + RC4M1 + DQDis4
    C4M2h = D4 + RC4M2 + DQDis4
    C4M3h = D4 + RC4M3 + DQDis4
    C5M1h = D5 + RC5M1 + DQDis5
    C5M2h = D5 + RC5M2 + DQDis5
    C5M3h = D5 + RC5M3 + DQDis5

    C1M1hsoft = np.exp(C1M1h)
    C1M2hsoft = np.exp(C1M2h)
    C1M3hsoft = np.exp(C1M3h)
    C2M1hsoft = np.exp(C2M1h)
    C2M2hsoft = np.exp(C2M2h)
    C2M3hsoft = np.exp(C2M3h)
    C3M1hsoft = np.exp(C3M1h)
    C3M2hsoft = np.exp(C3M2h)
    C3M3hsoft = np.exp(C3M3h)
    C4M1hsoft = np.exp(C4M1h)
    C4M2hsoft = np.exp(C4M2h)
    C4M3hsoft = np.exp(C4M3h)
    C5M1hsoft = np.exp(C5M1h)
    C5M2hsoft = np.exp(C5M2h)
    C5M3hsoft = np.exp(C5M3h)
    softM1 = C1M1hsoft + C2M1hsoft + C3M1hsoft + C4M1hsoft + C5M1hsoft;
    softM2 = C1M2hsoft + C2M2hsoft + C3M2hsoft + C4M2hsoft + C5M2hsoft;
    softM3 = C1M3hsoft + C2M3hsoft + C3M3hsoft + C4M3hsoft + C5M3hsoft;

    WC1M1 = C1M1hsoft / softM1;
    WC1M2 = C1M2hsoft / softM2;
    WC1M3 = C1M3hsoft / softM3;
    WC2M1 = C2M1hsoft / softM1;
    WC2M2 = C2M2hsoft / softM2;
    WC2M3 = C2M3hsoft / softM3;
    WC3M1 = C3M1hsoft / softM1;
    WC3M2 = C3M2hsoft / softM2;
    WC3M3 = C3M3hsoft / softM3;
    WC4M1 = C4M1hsoft / softM1;
    WC4M2 = C4M2hsoft / softM2;
    WC4M3 = C4M3hsoft / softM3;
    WC5M1 = C5M1hsoft / softM1;
    WC5M2 = C5M2hsoft / softM2;
    WC5M3 = C5M3hsoft / softM3;



    #define the client contribution scales and the local updates per each client
    #client 1
    scale =0
    D0=0.25
    if 1 in R_cls:
        ...
        if D1>D0:
            scale == 1  #very good
            local_ep1 = 12
            print ("C1 local epochs:",local_ep1)
        else:
            scale == 2    #good
            local_ep1= 9
            print ("C1 local epochs:",local_ep1)
    else:
        D1NR = len(train_loader_C1) / sum(lenNR)
        if D1>D0:
            scale == 4     #very bad
            local_ep1 = 7
            print ("C1 local epochs:",local_ep1)
    ...
    if 2 in R_cls:
        ...
        if D2>D0:
            scale == 1  #very good
            local_ep2 = 12
            print ("C2 local epochs:",local_ep2)
        else:
            scale == 2    #good
            local_ep2= 9
            print ("C2 local epochs:",local_ep2)
    else:
        D2NR = len(train_loader_C2) / sum(lenNR)
        if D2>D0:
            scale == 4     #very bad
            local_ep2 = 7
            print ("C2 local epochs:",local_ep2)
    ...
    if 3 in R_cls:
        ...
        if D3>D0:
            scale == 1  #very good
            local_ep3 = 12
            print ("C3 local epochs:",local_ep3)
        else:
            scale == 2    #good
            local_ep3= 9
            print ("C3 local epochs:",local_ep3)
    else:
        D3NR = len(train_loader_C3) / sum(lenNR)
        if D3>D0:
            scale == 4     #very bad
            local_ep3 = 7
            print ("C3 local epochs:",local_ep3)
    ...
    if 4 in R_cls:
        ...
        if D4>D0:
            scale == 1  #very good
            local_ep4 = 12
            print ("C4 local epochs:",local_ep4)
        else:
            scale == 2    #good
            local_ep4= 9
            print ("C4 local epochs:",local_ep4)
    else:
        D4NR = len(train_loader_C4) / sum(lenNR)
        if D4>D0:
            scale == 4     #very bad
            local_ep4 = 7
            print ("C4 local epochs:",local_ep4)
    ...
    if 5 in R_cls:
        ...
        if D5>D0:
            scale == 1  #very good
            local_ep5 = 12
            print ("C5 local epochs:",local_ep5)
        else:
            scale == 2    #good
            local_ep5= 9
            print ("C5 local epochs:",local_ep5)
    else:
        D5NR = len(train_loader_C5) / sum(lenNR)
        if D5>D0:
            scale == 4     #very bad
            local_ep5 = 7
            print ("C5 local epochs:",local_ep5)
    ...
    #updated parameters
    C1M1.update((x,y*WC1M1) for x,y in C1M1.items())
    C1M2.update((x,y*WC1M2) for x,y in C1M2.items())
    C1M3.update((x,y*WC1M3) for x,y in C1M3.items())
    C2M1.update((x,y*WC2M1) for x,y in C2M1.items())
    C2M2.update((x,y*WC2M2) for x,y in C2M2.items())
    C2M3.update((x,y*WC2M3) for x,y in C2M3.items())
    C3M1.update((x,y*WC3M1) for x,y in C3M1.items())
    C3M2.update((x,y*WC3M2) for x,y in C3M2.items())
    C3M3.update((x,y*WC3M3) for x,y in C3M3.items())
    C4M1.update((x,y*WC4M1) for x,y in C4M1.items())
    C4M2.update((x,y*WC4M2) for x,y in C4M2.items())
    C4M3.update((x,y*WC4M3) for x,y in C4M3.items())
    C5M1.update((x,y*WC5M1) for x,y in C5M1.items())
    C5M2.update((x,y*WC5M2) for x,y in C5M2.items())
    C5M3.update((x,y*WC5M3) for x,y in C5M3.items())

    G1dict = [C1M1,C2M1,C3M1,C4M1,C5M1]
    G2dict = [C1M2,C2M2,C3M2,C4M2,C5M2]
    G3dict = [C1M3,C2M3,C3M3,C4M3,C5M3]
        ...
        for epoch in range(args.val_global_ep):
            ...
            if cl_idx == 1:
                g_val_epoch_loss, g_val_epoch_acc, g_val_epoch_iouwithback, g_val_epoch_iounoback, g_valepoch_iou_class0, g_valepoch_iou_class1, g_valepoch_iou_class2, g_valepoch_iou_class3, g_valepoch_iou_class4 = eval(
                    val_loader, global_model1_fed, global_model2_fed, global_model3_fed, loss_fn, folder,SC1_EPL)
            ...
            if cl_idx == 2:
                g_val_epoch_loss, g_val_epoch_acc, g_val_epoch_iouwithback, g_val_epoch_iounoback, g_valepoch_iou_class0, g_valepoch_iou_class1, g_valepoch_iou_class2, g_valepoch_iou_class3, g_valepoch_iou_class4 = eval(
                    val_loader, global_model1_fed, global_model2_fed, global_model3_fed, loss_fn, folder,SC2_EPL)
            ...
            if cl_idx == 3:
                g_val_epoch_loss, g_val_epoch_acc, g_val_epoch_iouwithback, g_val_epoch_iounoback, g_valepoch_iou_class0, g_valepoch_iou_class1, g_valepoch_iou_class2, g_valepoch_iou_class3, g_valepoch_iou_class4 = eval(
                    val_loader, global_model1_fed, global_model2_fed, global_model3_fed, loss_fn, folder,SC3_EPL)
            ...
            if cl_idx == 4:
                g_val_epoch_loss, g_val_epoch_acc, g_val_epoch_iouwithback, g_val_epoch_iounoback, g_valepoch_iou_class0, g_valepoch_iou_class1, g_valepoch_iou_class2, g_valepoch_iou_class3, g_valepoch_iou_class4 = eval(
                    val_loader,global_model1_fed, global_model2_fed, global_model3_fed, loss_fn, folder,SC4_EPL)
            ...
            if cl_idx == 5:
                g_val_epoch_loss, g_val_epoch_acc, g_val_epoch_iouwithback, g_val_epoch_iounoback, g_valepoch_iou_class0, g_valepoch_iou_class1, g_valepoch_iou_class2, g_valepoch_iou_class3, g_valepoch_iou_class4 = eval(
                    val_loader,global_model1_fed, global_model2_fed, global_model3_fed, loss_fn, folder,SC5_EPL)
    ...
    if least_lossg > avg_g_val_loss:
            ...
            best_epoch = epoch
            torch.save(global_model1_fed.state_dict(), parentF+'./Outmain/noisycom/Fed_Avg/Checkpoints/M1_globalcheckpoint.pth')
            torch.save(global_model2_fed.state_dict(), parentF+'./Outmain/noisycom/Fed_Avg/Checkpoints/M2_globalcheckpoint.pth')
            torch.save(global_model3_fed.state_dict(), parentF+'./Outmain/noisycom/Fed_Avg/Checkpoints/M3_globalcheckpoint.pth')
            print('Global best model saved')
            print('-' * 50)

# ------------------------------------------TESTING USING THE SCREENING GLOBAL MODEL-----------------------------------------------------------------------
    test_folder = parentF+"Outmain/noisycom/Fed_Avg/testingsaved"
    for epoch in range(args.val_global_ep):
        print("Global testing.........")
        test_epoch_loss, test_epoch_acc, test_epoch_accwithback,test_epoch_accnoback = test(test_loader,  global_model1_fed, global_model2_fed, global_model3_fed, loss_fn, test_folder)
        print('\n')
        print(
                    ...
                    if cl_idx in R_cls:
                        ...
                        if cl_idx == 1:  # C1---------------------------------------------------------------C1 local training & validation--------------------------------------------------------------------------------------------------------------------
                            for epoch in range(local_ep1):
                                ...
                                train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1, trainepoch_iou_class2, trainepoch_iou_class3, trainepoch_iou_class4 = train(
                                    train_loader, local_model1R, local_model2R, local_model3R, C1m1opR, C1m2opR,
                                    C1m3opR, loss_fn, SC1_PL)
                                print("Client", cl_idx, "local validating.........")
                                val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1, valepoch_iou_class2, valepoch_iou_class3, valepoch_iou_class4 = eval(
                                    val_loader, local_model1R, local_model2R, local_model3R, loss_fn, folder, SC1_EPL)
                                ...
                                if least_lossC1R > val_epoch_loss:
                                    ...
                                    torch.save(local_model1R.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C1M1_localcheckpointR.pth')
                                    torch.save(local_model2R.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C1M2_localcheckpointR.pth')
                                    torch.save(local_model3R.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C1M3_localcheckpointR.pth')
                                    print('C1localmodel saved')
                        ...
                        if cl_idx == 2:  # C2--------------------------------------------------------------C2 local training & validation--------------------------------------------------------------------------------------------------------------------
                            for epoch in range(local_ep2):
                                ...
                                train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1, trainepoch_iou_class2, trainepoch_iou_class3, trainepoch_iou_class4 = train(
                                    train_loader, local_model1R, local_model2R, local_model3R, C2m1opR, C2m2opR,
                                    C2m3opR, loss_fn, SC2_PL)
                                print("Client", cl_idx, "local validating.........")
                                val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1, valepoch_iou_class2, valepoch_iou_class3, valepoch_iou_class4 = eval(
                                    val_loader, local_model1R, local_model2R, local_model3R, loss_fn, folder, SC2_EPL)
                                ...
                                if least_lossC2R > val_epoch_loss:
                                    ...
                                    torch.save(local_model1R.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C2M1_localcheckpointR.pth')
                                    torch.save(local_model2R.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C2M2_localcheckpointR.pth')
                                    torch.save(local_model3R.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C2M3_localcheckpointR.pth')
                                    print('C2localmodel saved')
                        ...
                        if cl_idx == 3:  # C3--------------------------------------------------------------C3 local training & validation-----------------------------------------------------------------------------------------------------------
                            for epoch in range(local_ep3):
                                ...
                                train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1, trainepoch_iou_class2, trainepoch_iou_class3, trainepoch_iou_class4 = train(
                                    train_loader, local_model1R, local_model2R, local_model3R, C3m1opR, C3m2opR,
                                    C3m3opR, loss_fn, SC3_PL)
                                print("Client", cl_idx, "local validating.........")
                                val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1, valepoch_iou_class2, valepoch_iou_class3, valepoch_iou_class4 = eval(
                                    val_loader, local_model1R, local_model2R, local_model3R, loss_fn, folder, SC3_EPL)
                                ...
                                if least_lossC3R > val_epoch_loss:
                                    ...
                                    torch.save(local_model1R.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C3M1_localcheckpointR.pth')
                                    torch.save(local_model2R.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C3M2_localcheckpointR.pth')
                                    torch.save(local_model3R.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C3M3_localcheckpointR.pth')
                                    print('C3localmodel saved')
    ...
    #----------------------------R local training finished------------------------------------------
            ...
            if (round_idxR < args.roundsR):
                ...
                M1dictR = [C1M1_LBR, C2M1_LBR, C3M1_LBR]
                M2dictR = [C1M2_LBR, C2M2_LBR, C3M2_LBR]
                M3dictR = [C1M3_LBR, C2M3_LBR, C3M3_LBR]
    ...
    # Starting global training-NR clients
        ...
        if (len(NR_cls) == 0):
            ...
            for NR_round in (range(args.roundsNR)):
                local_weights1NR, local_weights2NR, local_weights3NR = [], [], []
                least_lossC1NR, least_lossC2NR, least_lossC3NR, least_lossC4NR, least_lossC5NR = 100000000, 100000000, 100000000, 100000000, 100000000;
                round_idxNR = NR_round + 1
                # --------------------------------------LOCAL TRAINING & VALIDATING---------------------------------------------------------------------------
                print(f'\n | Global Training Round_NR: {round_idxNR} |\n')
                for cl_idx in NR_cls:
                    local_model1NR = copy.deepcopy(global_model1_fedNR)
                    local_model2NR = copy.deepcopy(global_model2_fedNR)
                    local_model3NR = copy.deepcopy(global_model3_fedNR)
                    ...
                    def grad_hook1(model, grad_input, grad_output):
                        global grads3
                        grads3 = grad_input[0].clone().detach()
                    local_model3NR.decoder1.register_full_backward_hook(grad_hook1)
                    ...
                    def grad_hook2(model, grad_input, grad_output):
                        global grads2
                        grads2 = grad_input[0].clone().detach()
                    local_model2NR.encoder1.register_full_backward_hook(grad_hook2)
                    ...
                    if cl_idx == 4:
                        ...
                        C4m1opNR = optim.Adam(local_model1NR.parameters(), lr=lr_C4)
                        C4m2opNR = optim.Adam(local_model2NR.parameters(), lr=lr_C4)
                        C4m3opNR = optim.Adam(local_model3NR.parameters(), lr=lr_C4)
                    if cl_idx == 5:
                        train_loader = train_loader_C5
                        val_loader = val_loader_C5
                        folder = parentF + "./Outmain/noisycom/Fed_Avg/Saved/local_models/client5"
                        C5m1opNR = optim.Adam(local_model1NR.parameters(), lr=lr_C5)
                        C5m2opNR = optim.Adam(local_model2NR.parameters(), lr=lr_C5)
                        C5m3opNR = optim.Adam(local_model3NR.parameters(), lr=lr_C5)
                    ...
                    if cl_idx in NR_cls:
                        ...
                        if cl_idx == 4:  # C4--------------------------------------------------------------C4 local training & validation-----------------------------------------------------------------------------------------------------------
                            for epoch in range(local_ep4):
                                ...
                                train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1, trainepoch_iou_class2, trainepoch_iou_class3, trainepoch_iou_class4 = train(
                                    train_loader, local_model1NR, local_model2NR, local_model3NR, C4m1opNR, C4m2opNR,
                                    C4m3opNR, loss_fn, SC4_PL)
                                print("Client", cl_idx, "local validating.........")
                                val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1, valepoch_iou_class2, valepoch_iou_class3, valepoch_iou_class4 = eval(
                                    val_loader, local_model1NR, local_model2NR, local_model3NR, loss_fn, folder,
                                    SC4_EPL)
                                ...
                                if least_lossC4NR > val_epoch_loss:
                                    least_lossC4NR = val_epoch_loss
                                    torch.save(local_model1NR.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C4M1_localcheckpointNR.pth')
                                    torch.save(local_model2NR.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C4M2_localcheckpointNR.pth')
                                    torch.save(local_model3NR.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C4M3_localcheckpointNR.pth')
                                    print('C4localmodel saved')
                        ...
                        if cl_idx == 5:  # C5--------------------------------------------------------------C5 local training & validation-----------------------------------------------------------------------------------------------------------
                            for epoch in range(local_ep5):
                                ...
                                train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1, trainepoch_iou_class2, trainepoch_iou_class3, trainepoch_iou_class4 = train(
                                    train_loader, local_model1NR, local_model2NR, local_model3NR, C5m1opNR, C5m2opNR,
                                    C5m3opNR, loss_fn, SC5_PL)
                                print("Client", cl_idx, "local validating.........")
                                val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1, valepoch_iou_class2, valepoch_iou_class3, valepoch_iou_class4 = eval(
                                    val_loader, local_model1NR, local_model2NR, local_model3NR, loss_fn, folder,
                                    SC5_EPL)
                                ...
                                if least_lossC5NR > val_epoch_loss:
                                    least_lossC5NR = val_epoch_loss
                                    torch.save(local_model1NR.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C5M1_localcheckpointNR.pth')
                                    torch.save(local_model2NR.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C5M2_localcheckpointNR.pth')
                                    torch.save(local_model3NR.state_dict(),parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C5M3_localcheckpointNR.pth')
                                    print('C5localmodel saved')
        ...
        C4M1 = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C4M1_localcheckpointNR.pth')
        C4M2 = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C4M2_localcheckpointNR.pth')
        C4M3 = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C4M3_localcheckpointNR.pth')
        C5M1 = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C5M1_localcheckpointNR.pth')
        C5M2 = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C5M2_localcheckpointNR.pth')
        C5M3 = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C5M3_localcheckpointNR.pth')
        ...
        for idx in idxs_users1:
            ...
            for epoch in range(args.val_global_ep):
                ...
                if cl_idx == 1:
                    g_val_epoch_loss, g_val_epoch_acc, g_val_epoch_iouwithback, g_val_epoch_iounoback, g_valepoch_iou_class0, g_valepoch_iou_class1, g_valepoch_iou_class2, g_valepoch_iou_class3, g_valepoch_iou_class4 = eval(
                        val_loader, global_model1_fedR, global_model2_fedR, global_model3_fedR, loss_fn, folder,SC1_EPL)
                    client1_g_val_acc.append(g_val_epoch_acc)
                    client1_g_val_loss.append(g_val_epoch_loss)
                    client1_g_val_iouwithback.append(g_val_epoch_iouwithback)
                    client1_g_val_iounoback.append(g_val_epoch_iounoback)
                if cl_idx == 2:
                    g_val_epoch_loss, g_val_epoch_acc, g_val_epoch_iouwithback, g_val_epoch_iounoback, g_valepoch_iou_class0, g_valepoch_iou_class1, g_valepoch_iou_class2, g_valepoch_iou_class3, g_valepoch_iou_class4 = eval(
                        val_loader, global_model1_fedR, global_model2_fedR, global_model3_fedR, loss_fn, folder,SC2_EPL)
                    client2_g_val_acc.append(g_val_epoch_acc)
                    client2_g_val_loss.append(g_val_epoch_loss)
                    client2_g_val_iouwithback.append(g_val_epoch_iouwithback)
                    client2_g_val_iounoback.append(g_val_epoch_iounoback)
                if cl_idx == 3:
                    g_val_epoch_loss, g_val_epoch_acc, g_val_epoch_iouwithback, g_val_epoch_iounoback, g_valepoch_iou_class0, g_valepoch_iou_class1, g_valepoch_iou_class2, g_valepoch_iou_class3, g_valepoch_iou_class4 = eval(
                        val_loader, global_model1_fedR, global_model2_fedR, global_model3_fedR, loss_fn, folder,SC3_EPL)
                    client3_g_val_acc.append(g_val_epoch_acc)
                    client3_g_val_loss.append(g_val_epoch_loss)
                    client3_g_val_iouwithback.append(g_val_epoch_iouwithback)
                    client3_g_val_iounoback.append(g_val_epoch_iounoback)
                if cl_idx == 4:
                    g_val_epoch_loss, g_val_epoch_acc, g_val_epoch_iouwithback, g_val_epoch_iounoback, g_valepoch_iou_class0, g_valepoch_iou_class1, g_valepoch_iou_class2, g_valepoch_iou_class3, g_valepoch_iou_class4 = eval(
                        val_loader,global_model1_fedR, global_model2_fedR, global_model3_fedR, loss_fn, folder,SC4_EPL)
                    client4_g_val_acc.append(g_val_epoch_acc)
                    client4_g_val_loss.append(g_val_epoch_loss)
                    client4_g_val_iouwithback.append(g_val_epoch_iouwithback)
                    client4_g_val_iounoback.append(g_val_epoch_iounoback)
                if cl_idx == 5:
                    g_val_epoch_loss, g_val_epoch_acc, g_val_epoch_iouwithback, g_val_epoch_iounoback, g_valepoch_iou_class0, g_valepoch_iou_class1, g_valepoch_iou_class2, g_valepoch_iou_class3, g_valepoch_iou_class4 = eval(
                        val_loader,global_model1_fedR, global_model2_fedR, global_model3_fedR, loss_fn, folder,SC5_EPL)
                    client5_g_val_acc.append(g_val_epoch_acc)
                    client5_g_val_loss.append(g_val_epoch_loss)
                    client5_g_val_iouwithback.append(g_val_epoch_iouwithback)
                    client5_g_val_iounoback.append(g_val_epoch_iounoback)
