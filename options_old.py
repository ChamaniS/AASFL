...
def args_parser():
    ...
    parser.add_argument('--mubad', type=float, default=0.07,
                        help='The hyper parameter for fedprox')
    parser.add_argument('--pack_prob_up_C1', type=float, default=0.0,
                        help='Packet loss probability: Uplink')
    parser.add_argument('--pack_prob_down_C1', type=float, default=0.0,
                        help='Packet loss probability: Downlink')
    parser.add_argument('--pack_prob_up_C2', type=float, default=0.0,
                        help='Packet loss probability: Uplink')
    parser.add_argument('--pack_prob_down_C2', type=float, default=0.0,
                        help='Packet loss probability: Downlink')
    parser.add_argument('--pack_prob_up_C3', type=float, default=0.0,
                        help='Packet loss probability: Uplink')
    parser.add_argument('--pack_prob_down_C3', type=float, default=0.0,
                        help='Packet loss probability: Downlink')
    parser.add_argument('--pack_prob_up_C4', type=float, default=0.9,
                        help='Packet loss probability: Uplink')
    parser.add_argument('--pack_prob_down_C4', type=float, default=0.9,
                        help='Packet loss probability: Downlink')
    parser.add_argument('--pack_prob_up_C5', type=float, default=0.9,
                        help='Packet loss probability: Uplink')
    parser.add_argument('--pack_prob_down_C5', type=float, default=0.9,
                        help='Packet loss probability: Downlink')
