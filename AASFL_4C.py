...
def main():
    ...
    C4hsoft = np.exp(C4h)
    C5hsoft = np.exp(C5h)
    softC =   C2hsoft+C3hsoft+C4hsoft+C5hsoft;
    b = C2hsoft / softC;
    c = C3hsoft / softC;
    d = C4hsoft / softC;
    e = C5hsoft / softC;
            ...
            for NR_round in (range(args.roundsNR)):
                ...
                for cl_idx in NR_cls:
                    ...
                    if (round_idxNR < args.roundsNR):
                        ...
                        M1dictNR = [C2M1_LBNR, C3M1_LBNR, C4M1_LBNR, C5M1_LBNR]
                        M2dictNR = [C2M2_LBNR, C3M2_LBNR, C4M2_LBNR, C5M2_LBNR]
                        M3dictNR = [C2M3_LBNR, C3M3_LBNR, C4M3_LBNR, C5M3_LBNR]
