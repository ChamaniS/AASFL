...
TEST_IMG_DIR = "C:/Users/csj5/Projects/HAM10000/HAM10000/part1_images/test/"
TEST_MASK_DIR = "C:/Users/csj5/Projects/HAM10000/HAM10000/part1_masks/test/"
...
def train_screen(train_loader, local_model1, local_model2, local_model3, optimizer1, optimizer2, optimizer3, loss_fn,PL):
    ...
    return epoch_loss, epoch_acc, epoch_iou_withbackground, epoch_iou_nobackground, epoch_iou_class0, epoch_iou_class1, isreliableclient
...
def main():
    ...
    for idx in range(5):
        ...
        for epoch in range(args.screen_ep):
            ...
            if cl_idx == 1:  # C1---------------------------------------------------------------C1 screen training & validation--------------------------------------------------------------------------------------------------------------------
                S_train_epoch_loss, S_train_epoch_acc, S_trainepoch_iou_withbackground, S_trainepoch_iou_nobackground, S_trainepoch_iou_class0, S_trainepoch_iou_class1, isreliable1 = train_screen(
    ...
    #Deciding the client contribution factor
    scale =0
    lenR, lenNR = [], []
    if 1 in R_cls:
    ...
    '''
    D1R = D2R = D3R = D4R = D5R = 0.2
    D1NR = D2NR = D3NR = D4NR = D5NR = 0.2
    D1 = D2 = D3 = D4 = D5 = 0.2
    '''

    # NR-GLOBAL UPDATE RATIOS
    S_C1 = (1 - args.pack_prob_up_C1)
    S_C2 = (1 - args.pack_prob_up_C2)
    S_C3 = (1 - args.pack_prob_up_C3)
    S_C4 = (1 - args.pack_prob_up_C4)
    S_C5 = (1 - args.pack_prob_up_C5)

    '''
    SC = S_C1 + S_C2 + S_C3 + S_C4 + S_C5
    RC1 = S_C1 / SC
    RC2 = S_C2 / SC
    RC3 = S_C3 / SC
    RC4 = S_C4 / SC
                    ...
                    if cl_idx in R_cls:
                        ...
                        if cl_idx == 1:  # C1---------------------------------------------------------------C1 local training & validation--------------------------------------------------------------------------------------------------------------------
                            for epoch in range(local_ep1):
                                ...
                                train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1= train(
                                    train_loader, local_model1R, local_model2R, local_model3R, C1m1opR, C1m2opR,C1m3opR, loss_fn, C1_PL)
                                print("Client", cl_idx, "local validating.........")
                        ...
                        if cl_idx == 2:  # C2--------------------------------------------------------------C2 local training & validation--------------------------------------------------------------------------------------------------------------------
                            for epoch in range(local_ep2):
                                ...
                                train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1 = train(
                                    train_loader, local_model1R, local_model2R, local_model3R, C2m1opR, C2m2opR,C2m3opR, loss_fn, C2_PL)
                                print("Client", cl_idx, "local validating.........")
                                val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1= eval(
                        ...
                        if cl_idx == 3:  # C3--------------------------------------------------------------C3 local training & validation-----------------------------------------------------------------------------------------------------------
                            for epoch in range(local_ep3):
                                ...
                                train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1 = train(
                                    train_loader, local_model1R, local_model2R, local_model3R, C3m1opR, C3m2opR,C3m3opR, loss_fn, C3_PL)
                                print("Client", cl_idx, "local validating.........")
                                val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1 = eval(
                    ...
                    if cl_idx in NR_cls:
                        ...
                        if cl_idx == 4:  # C4--------------------------------------------------------------C4 local training & validation-----------------------------------------------------------------------------------------------------------
                            for epoch in range(local_ep4):
                                ...
                                train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1 = train(
                                    train_loader, local_model1NR, local_model2NR, local_model3NR, C4m1opNR, C4m2opNR,C4m3opNR, loss_fn, C4_PL)
                                print("Client", cl_idx, "local validating.........")
                                val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1= eval(
                        ...
                        if cl_idx == 5:  # C5--------------------------------------------------------------C5 local training & validation-----------------------------------------------------------------------------------------------------------
                            for epoch in range(local_ep5):
                                ...
                                train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1 = train(
                                    train_loader, local_model1NR, local_model2NR, local_model3NR, C5m1opNR, C5m2opNR,C5m3opNR, loss_fn, C5_PL)
                                print("Client", cl_idx, "local validating.........")
                                val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1= eval(
