...
dataDir="C:/Users/csj5/Projects/Data/BlastocystDATA/datafed/highly-nonuniform/federated/"
            ...
            for NR_round in (range(args.roundsNR)):
                ...
                for cl_idx in NR_cls:
                    ...
                    if (round_idxNR < args.roundsNR):
                        ...
                        M1dictNR = [C3M1_LBNR, C4M1_LBNR, C5M1_LBNR]
                        M2dictNR = [C3M2_LBNR, C4M2_LBNR, C5M2_LBNR]
                        M3dictNR = [C3M3_LBNR, C4M3_LBNR, C5M3_LBNR]
