...
dataDir = "C:/Users/csj5/Projects/Data/BlastocystDATA/7Clients/HNU/"
...
def main():
    ...
    C6hsoft = np.exp(C6h)
    C7hsoft = np.exp(C7h)
    softC = C3hsoft + C4hsoft + C5hsoft + C6hsoft + C7hsoft;
        ...
        if (len(R_cls) == 0):
            ...
            for R_round in (range(args.roundsR)):
                ...
                if (round_idxR < args.roundsR):
                    ...
                    M1dictR = [C1M1_LBR, C2M1_LBR]
                    M2dictR = [C1M2_LBR, C2M2_LBR]
                    M3dictR = [C1M3_LBR, C2M3_LBR]
            ...
            for NR_round in (range(args.roundsNR)):
                ...
                for cl_idx in NR_cls:
                    ...
                    if (round_idxNR < args.roundsNR):
                        ...
                        M1dictNR = [C3M1_LBNR, C4M1_LBNR, C5M1_LBNR, C6M1_LBNR, C7M1_LBNR]
                        M2dictNR = [C3M2_LBNR, C4M2_LBNR, C5M2_LBNR, C6M2_LBNR, C7M2_LBNR]
                        M3dictNR = [C3M3_LBNR, C4M3_LBNR, C5M3_LBNR, C6M3_LBNR, C7M3_LBNR]
