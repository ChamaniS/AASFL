...
import random
import time
from errorcorrection_main.cal_epoch_3C import cal_epoch
from errorcorrection_main.cal_lr_3C import cal_lr
...
def main():
    ...
    SC1_PL, SC2_PL, SC3_PL, SC4_PL, SC5_PL, SC1_EPL, SC2_EPL, SC3_EPL= [], [], [], [], [], [], [], []
    imgsize = 256
    for c in range(1, 4):
        if (c == 1):  # C1------------------------------------------------
    ...
    tot_loader = len(train_loader_C1) + len(train_loader_C2) + len(train_loader_C3)
    ...
    least_lossC1S, least_lossC2S, least_lossC3S = 100000000, 100000000, 100000000;
    R_cls = []
    NR_cls = []
    for idx in range(3):
    ...
    G1dict = [C1M1, C2M1, C3M1]
    G2dict = [C1M2, C2M2, C3M2]
    G3dict = [C1M3, C2M3, C3M3]
    ...
    spertime = []
    spertime.extend([s1pertime, s2pertime, s3pertime])
    Tmax = max(spertime)
    ...
    print("coefficients:", e11, e12, e13, e21, e22, e23, e31, e32, e33)
    # Using the least squares method to decide the epochs for each client
    E1, E2, E3 = cal_epoch(e11, e12, e13, e21, e22, e23, e31, e32, e33)
    ...
    print("coefficients:", n11, n12, n21, n22, n31, n32)
    n1, n2, n3 = cal_lr(n11, n12, n21, n22, n31, n32)
    ...
    C1_PL, C2_PL, C3_PL, C4_PL, C5_PL, C1_EPL, C2_EPL, C3_EPL= [], [], [], [], [], [], [], []
    C1T, C2T, C3T= [], [], []
    ...
    for com_round in (range(args.comrounds)):
        ...
        tot_gloss = client1_g_val_loss[0] + client2_g_val_loss[0] + client3_g_val_loss[0]
        avg_g_val_loss = tot_gloss / 3;
