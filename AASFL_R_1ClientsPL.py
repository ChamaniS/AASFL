...
import random
import time
from errorcorrection_main.cal_epoch_R_1 import cal_epoch
from errorcorrection_main.cal_lr_R_1 import cal_lr
...
def main():
    ...
    tot_loader = len(train_loader_C1) + len(train_loader_C2) + len(train_loader_C3) + len(train_loader_C4)
    ...
    G1dict = [C1M1,C2M1,C3M1,C4M1]
    G2dict = [C1M2,C2M2,C3M2,C4M2]
    G3dict = [C1M3,C2M3,C3M3,C4M3]
    ...
    spertime=[]
    spertime.extend([s1pertime, s2pertime, s3pertime,s4pertime])
    Tmax = max(spertime)
    ...
    print ("coefficients:", e11, e12, e13, e21, e22, e23,e31, e32, e33, e41, e42, e43)
    #Using the least squares method to decide the epochs for each client
    E1,E2,E3,E4= cal_epoch(e11, e12, e13, e21, e22, e23,e31, e32, e33, e41, e42, e43)
    ...
    print ("coefficients:", n11, n12, n21, n22,n31, n32, n41, n42)
    n1,n2,n3,n4 = cal_lr(n11, n12, n21, n22,n31, n32, n41, n42)
    ...
    for com_round in (range(args.comrounds)):
        ...
        intot_loss = (1 / DQ1 + 1 / DQ2 + 1 / DQ3 + 1 / DQ4)
