...
from utils_splitfed import (get_loaders, eval, get_loaders_test, test)
...
def main():
    ...
    for com_round in (range(args.rounds)):
        ...
        # Model1Averaging
        M1dict = [C1M1localbest, C2M1localbest, C3M1localbest, C4M1localbest]
        M2dict = [C1M2localbest, C2M2localbest, C3M2localbest, C4M2localbest]
        M3dict = [C1M3localbest, C2M3localbest, C3M3localbest, C4M3localbest]
