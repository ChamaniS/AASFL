...
from utils_splitfed_kvasir import (get_loaders, eval, get_loaders_test, test)
import matplotlib.pyplot as plt
import segmentation_models_pytorch as smp
from sklearn.metrics import jaccard_score
from options_old import args_parser
...
def main():
    ...
    for com_round in (range(args.rounds)):
            ...
            for epoch in range(args.local_ep):
                ...
                if cl_idx == 1:  # C1---------------------------------------------------------------C1 local training & validation--------------------------------------------------------------------------------------------------------------------
                    ...
                    if least_lossC1 > val_epoch_loss:
                        ...
                        torch.save(local_model1.state_dict(),
                                   parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C1M1_localcheckpoint.pth')
                        torch.save(local_model2.state_dict(),
                                   parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C1M2_localcheckpoint.pth')
                        torch.save(local_model3.state_dict(),
                                   parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C1M3_localcheckpoint.pth')
                ...
                if cl_idx == 2:  # C2--------------------------------------------------------------C2 local training & validation--------------------------------------------------------------------------------------------------------------------
                    ...
                    if least_lossC2 > val_epoch_loss:
                        ...
                        torch.save(local_model1.state_dict(),
                                   parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C2M1_localcheckpoint.pth')
                        torch.save(local_model2.state_dict(),
                                   parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C2M2_localcheckpoint.pth')
                        torch.save(local_model3.state_dict(),
                                   parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C2M3_localcheckpoint.pth')
                ...
                if cl_idx == 3:  # C3--------------------------------------------------------------C3 local training & validation-----------------------------------------------------------------------------------------------------------
                    ...
                    if least_lossC3 > val_epoch_loss:
                        ...
                        torch.save(local_model1.state_dict(),
                                   parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C3M1_localcheckpoint.pth')
                        torch.save(local_model2.state_dict(),
                                   parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C3M2_localcheckpoint.pth')
                        torch.save(local_model3.state_dict(),
                                   parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C3M3_localcheckpoint.pth')
                ...
                if cl_idx == 4:  # C4--------------------------------------------------------------C4 local training & validation-----------------------------------------------------------------------------------------------------------
                    ...
                    if least_lossC4 > val_epoch_loss:
                        ...
                        torch.save(local_model1.state_dict(),
                                   parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C4M1_localcheckpoint.pth')
                        torch.save(local_model2.state_dict(),
                                   parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C4M2_localcheckpoint.pth')
                        torch.save(local_model3.state_dict(),
                                   parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C4M3_localcheckpoint.pth')
                ...
                if cl_idx == 5:  # C5--------------------------------------------------------------C5 local training & validation-----------------------------------------------------------------------------------------------------------
                    ...
                    if least_lossC5 > val_epoch_loss:
                        ...
                        torch.save(local_model1.state_dict(),
                                   parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C5M1_localcheckpoint.pth')
                        torch.save(local_model2.state_dict(),
                                   parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C5M2_localcheckpoint.pth')
                        torch.save(local_model3.state_dict(),
                                   parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C5M3_localcheckpoint.pth')
        ...
        C1M1localbest = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C1M1_localcheckpoint.pth')
        C1M2localbest = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C1M2_localcheckpoint.pth')
        C1M3localbest = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C1M3_localcheckpoint.pth')
        C2M1localbest = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C2M1_localcheckpoint.pth')
        C2M2localbest = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C2M2_localcheckpoint.pth')
        C2M3localbest = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C2M3_localcheckpoint.pth')
        C3M1localbest = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C3M1_localcheckpoint.pth')
        C3M2localbest = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C3M2_localcheckpoint.pth')
        C3M3localbest = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C3M3_localcheckpoint.pth')
        C4M1localbest = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C4M1_localcheckpoint.pth')
        C4M2localbest = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C4M2_localcheckpoint.pth')
        C4M3localbest = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C4M3_localcheckpoint.pth')
        C5M1localbest = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C5M1_localcheckpoint.pth')
        C5M2localbest = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C5M2_localcheckpoint.pth')
        C5M3localbest = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C5M3_localcheckpoint.pth')
