...
from utils_splitfed_HAM import (get_loaders, eval, get_loaders_test, test)
...
from errorcorrection_main.cal_lr_old import cal_lr
...
dataDir="C:/Users/csj5/Projects/Data/HAM10000/HAM10000/datafed/highly_nonuniform/"
...
def main():
    ...
    e52 =S_C5
    print ("coefficients:", e11, e12, e13, e21, e22, e23,e31, e32, e33, e41, e42, e43, e51, e52, e53)
    n1,n2,n3,n4,n5 = cal_lr(e11, e12, e21, e22,e31, e32, e41, e42, e51, e52)
                    ...
                    if cl_idx in R_cls:
                        ...
                        if cl_idx == 1:  # C1---------------------------------------------------------------C1 local training & validation--------------------------------------------------------------------------------------------------------------------
                            for epoch in range(local_ep1):
                                ...
                                train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1 = train(
                                    train_loader, local_model1R, local_model2R, local_model3R, C1m1opR,
                                    C1m2opR, C1m3opR, scheduler1, scheduler2, scheduler3, loss_fn, SC1_PL)
                                print("Client", cl_idx, "local validating.........")
                                val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1 = eval(
                                    val_loader, local_model1R, local_model2R, local_model3R, loss_fn, folder,
                                    SC1_EPL)
                        ...
                        if cl_idx == 2:  # C2--------------------------------------------------------------C2 local training & validation--------------------------------------------------------------------------------------------------------------------
                            for epoch in range(local_ep2):
                                ...
                                train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1 = train(
                                    train_loader, local_model1R, local_model2R, local_model3R, C2m1opR, C2m2opR,C2m3opR,scheduler1,scheduler2,scheduler3, loss_fn, SC2_PL)
                                print("Client", cl_idx, "local validating.........")
                                val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1 = eval(
                        ...
                        if cl_idx == 3:  # C3--------------------------------------------------------------C5 local training & validation-----------------------------------------------------------------------------------------------------------
                            for epoch in range(local_ep3):
                                print(f"[INFO]: Epoch {epoch + 1} of {local_ep3}")
                                print("Client", cl_idx, " training.........")
                                start_timec3 = time.time()
                                train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1 = train(
                                    train_loader, local_model1R, local_model2R, local_model3R, C3m1opR, C3m2opR,C3m3opR,scheduler1,scheduler2,scheduler3, loss_fn, SC5_PL)
                                print("Client", cl_idx, "local validating.........")
                                val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1 = eval(
                                    val_loader, local_model1R, local_model2R, local_model3R, loss_fn, folder,SC5_EPL)
                                ...
                                C3time = C3time + c3t
                                print("C5 cumulative time:", C3time)
            ...
            for NR_round in (range(args.roundsNR)):
                ...
                for cl_idx in NR_cls:
                    ...
                    if cl_idx == 3:
                        ...
                        val_loader = val_loader_C3
                        folder = parentF + "./Outmain/noisycom/Fed_Avg/Saved/local_models/client3"
                        C4m1opNR = optim.Adam(local_model1NR.parameters(), lr=lr_C3)
                        C4m2opNR = optim.Adam(local_model2NR.parameters(), lr=lr_C3)
                        C4m3opNR = optim.Adam(local_model3NR.parameters(), lr=lr_C3)
                    ...
                    # NR clients training
                        if cl_idx == 4:  # C4--------------------------------------------------------------C4 local training & validation-----------------------------------------------------------------------------------------------------------
                            for epoch in range(local_ep4):
                                ...
                                train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1 = train(
                                    train_loader, local_model1NR, local_model2NR, local_model3NR, C4m1opNR, C4m2opNR,C4m3opNR, scheduler1,scheduler2,scheduler3, loss_fn, SC4_PL)
                                print("Client", cl_idx, "local validating.........")
                                val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1 = eval(
                                    val_loader, local_model1NR, local_model2NR, local_model3NR, loss_fn, folder,SC4_EPL)
                        ...
                        if cl_idx == 5:  # C5--------------------------------------------------------------C5 local training & validation-----------------------------------------------------------------------------------------------------------
                            for epoch in range(local_ep5):
                                ...
                                train_epoch_loss, train_epoch_acc, trainepoch_iou_withbackground, trainepoch_iou_nobackground, trainepoch_iou_class0, trainepoch_iou_class1 = train(
                                    train_loader, local_model1NR, local_model2NR, local_model3NR, C5m1opNR, C5m2opNR,C5m3opNR,scheduler1,scheduler2,scheduler3, loss_fn, SC5_PL)
                                print("Client", cl_idx, "local validating.........")
                                val_epoch_loss, val_epoch_acc, valepoch_iou_withbackground, valepoch_iou_nobackground, valepoch_iou_class0, valepoch_iou_class1 = eval(
                                    val_loader, local_model1NR, local_model2NR, local_model3NR, loss_fn, folder,SC5_EPL)
