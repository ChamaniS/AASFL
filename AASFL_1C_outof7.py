...
def main():
    ...
    D5R = len(train_loader_C5) / sum(lenNR)
    D6R = len(train_loader_C6) / sum(lenNR)
        ...
        if (len(R_cls) == 0):
            ...
            for R_round in (range(args.roundsR)):
                ...
                if (round_idxR < args.roundsR):
                    ...
                    M1dictR = [C1M1_LBR, C2M1_LBR,C3M1_LBR,C4M1_LBR,C5M1_LBR,C6M1_LBR]
                    M2dictR = [C1M2_LBR, C2M2_LBR,C3M2_LBR,C4M2_LBR,C5M2_LBR,C6M2_LBR]
                    M3dictR = [C1M3_LBR, C2M3_LBR,C3M3_LBR,C4M3_LBR,C5M3_LBR,C6M3_LBR]
