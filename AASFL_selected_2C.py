...
def main():
    ...
    tot_loader = len(train_loader_C1) + len(train_loader_C2)
    ...
    spertime = []
    spertime.extend([s1pertime, s2pertime])
    Tmax = max(spertime)
    ...
    print("coefficients:", e11, e12, e13, e21, e22, e23)
    # Using the least squares method to decide the epochs for each client
    E1, E2 = cal_epoch(e11, e12, e13, e21, e22, e23)
    ...
    n22 = S_C2
    print("coefficients:", n11, n12, n21, n22)
    n1, n2 = cal_lr(n11, n12, n21, n22)
    ...
    C1_PL, C2_PL, C3_PL, C4_PL, C5_PL, C1_EPL, C2_EPL = [], [], [], [], [], [], []
    C1T, C2T = [], []
    ...
    for com_round in (range(args.comrounds)):
       ...
       # C3M2 = torch.load(parentF + './Outmain/noisycom/Fed_Avg/Checkpoints/C3M2_localcheckpointR.pth')
        ...
        tot_gloss = client1_g_val_loss[0] + client2_g_val_loss[0]
        avg_g_val_loss = tot_gloss / 2;
